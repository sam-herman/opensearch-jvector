...
public enum StatNames {
    ...
    KNN_QUERY_VISITED_NODES(KNNCounter.KNN_QUERY_VISITED_NODES.getName()),
    KNN_QUERY_RERANKED_COUNT(KNNCounter.KNN_QUERY_RERANKED_COUNT.getName()),
    KNN_QUERY_EXPANDED_NODES(KNNCounter.KNN_QUERY_EXPANDED_NODES.getName()),
    KNN_QUERY_EXPANDED_BASE_LAYER_NODES(KNNCounter.KNN_QUERY_EXPANDED_BASE_LAYER_NODES.getName()),
    KNN_QUERY_GRAPH_SEARCH_TIME(KNNCounter.KNN_QUERY_GRAPH_SEARCH_TIME.getName()),
    KNN_QUANTIZATION_TRAINING_TIME(KNNCounter.KNN_QUANTIZATION_TRAINING_TIME.getName()),
    KNN_GRAPH_MERGE_TIME(KNNCounter.KNN_GRAPH_MERGE_TIME.getName());
